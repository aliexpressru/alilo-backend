module github.com/aliexpressru/alilo-backend
...
require (
	...
	github.com/googleapis/googleapis v0.0.0-20211005231101-409e134ffaac
	github.com/grafana/grafana-foundation-sdk/go v0.0.0-20250207135736-a8156863a47b
